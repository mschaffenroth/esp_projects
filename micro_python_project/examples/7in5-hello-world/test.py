...
mosi = machine.Pin(34) # mosi / din
sck = machine.Pin(36) # clk / sclk
miso = machine.Pin(32) # cs / miso

print("start")
#spi = SPI(0, SPI.MASTER, baudrate=2000000, polarity=0, phase=0, sck=sck, mosi=mosi, miso=miso)
